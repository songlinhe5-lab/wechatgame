...
description: 运行游戏开发工作室专家团流程时使用。当用户要求启动完整游戏开发流程、阶段诊断、质量门评审、调度工作室成员，或提到七阶段 SOP、质量门、PASS/CONCERNS/FAIL、spawn 成员、编排时触发。定义七阶段流水线、spawn 任务模板与铁律。
---

# wxgame 工作室编排法（七阶段 SOP）

提炼自本 monorepo 首款 demo 的完整工作室流程（Breakout 全程跑通）。
