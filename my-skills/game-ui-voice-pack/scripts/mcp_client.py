...
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/game-ui-voice-pack/channels/skillhub/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/game-ui-voice-pack/channels/skillhub/v{version}"
