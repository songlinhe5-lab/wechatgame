...
| S6 | 道具系统 | `gdd/powerups.md`（待写） | P1 | 区域消除/槽位清空/随机消除三道具 + 激励视频位 |
...
| v1.2 | 2026-09-11 | §3.8 `TOUCH_MIN` 语义澄清：88px 限定 UI 控件；棋盘/托盘珠命中区=外扩 8px（66²/62²），不扩至 88（防跨格误触，重叠按格心最近命中）。数值不变，仅消歧 | S2 input-control §2.2 定稿 + 主理人裁决 |
