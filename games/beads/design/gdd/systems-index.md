...
| S9 | 暂停与设置 | `gdd/pause-settings.md` | P1 | 暂停状态、音乐/音效开关；**v1.28：回主菜单次钮（保留进度不惩罚）+ 震动行** |
