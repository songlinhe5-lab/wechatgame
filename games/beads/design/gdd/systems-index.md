...
| S10 | 元游戏（主菜单+页族） | `gdd/meta-ui.md`（**待建，WXG-T-164 批0**） | P1 | **v1.28 新增**（反转 ux-spec §2「主菜单有意移除」与 meta-framework M4/M5，用户 2026-09-18 拍板）：主菜单/overlay 页族（设置/签到/图鉴/排行榜/名片/体力）、体力与钱包服务、meta sidecar 存档；架构 = BeadsShell 双对象（玩法冻结面零扰动） |
...
| `STAMINA_START_COST` | 1 | 普通局开局消耗；第二模式入口当前不存在，其余模式消耗不冻结 |
