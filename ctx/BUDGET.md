...
> **常驻总量**（AGENTS.md + my-rules/* + ctx/hot-files.md + ctx/ROUTES.md，每次会话固定开销）= **12855** 估算 tokens（观察哨软阈值 ≤ 13500）：单文件上限各自为政时总量仍可漂移，本行仅观察提示、不阻断；硬阻断只挂各单文件门。
...
| 10 | `production/epics/epics-beads.md` | 7854 | 292 | normal |
...
| 15 | `production/qa/beads/test-cases.md` | 7282 | 197 | hot |
| 16 | `memory/2026-09-14.md` | 7257 | 166 | normal |
| 17 | `games/breakout/cocos/extensions/cocos-mcp-server/README.EN.md` | 7240 | 525 | normal |
| 18 | `production/TASKS.md` | 7224 | 44 | hot |
