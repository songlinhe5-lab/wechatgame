...
| 3 | `production/TASKS-DETAIL.md` | 35353 | 534 | normal |
...
| `production/TASKS-DETAIL.md` | 35353 | 见 `ctx/budget-exempt.json`（无豁免则 ❌ 需报告主理人） |
...
| `games/beads/design/gdd/input-control.md` | 8767 | 见 `ctx/budget-exempt.json`（无豁免则 ❌ 需报告主理人） |
