...
## `production/TASKS.md` — 38 行 / 2550 tok / 实测读 4 次

§WXG 任务台账（SSOT）=1+39 · §待排（backlog，无号，立项时领取）=26+14
...
## `production/TASKS-DETAIL.md` — 114 行 / 5687 tok

§WXG 任务台账 · 详情（标题制正文侧）=1+115 · §WXG-T-058=18+8 · §WXG-T-055=26+8 · §WXG-T-056=34+8 · §WXG-T-059=42+8 · §WXG-T-060=50+8 · §WXG-T-061=58+8 · §WXG-T-062=66+8 · §WXG-T-063=74+8 · §WXG-T-064=82+12 · §WXG-T-065=94+11 · §WXG-T-066=105+11
