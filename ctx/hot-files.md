...
## `production/TASKS.md` — 43 行 / 2429 tok / 实测读 4 次

§WXG 任务台账（SSOT）=1+44 · §待排（backlog，无号，立项时领取）=33+12
...
## `knowledge/INDEX.md` — 129 行 / 3170 tok

§knowledge/ — 工作室知识库（WXG-T-023）=1+130 · §1 读取协议（开发前期）=7+6 · §2 写入协议（任务收尾）=13+21 · §3 文件分工=34+9 · §4 维护=43+6 · §5 生命周期（访问记账 → 归档 → 重新激活）=49+41 · §5.1 命令表=51+12 · §5.2 归档阈值（用户 2026-09-12 裁定，存于 `ledger.json.thresholds`）=63+9 · §5.3 重新激活与合并=72+7 · §5.4 `accessSources` 截断（R4，WXG-T-038）=79+11 · §6 活跃条目（自动生成）=90+41
...
## `production/TASKS-DETAIL.md` — 165 行 / 7863 tok

§WXG 任务台账 · 详情（标题制正文侧）=1+166 · §WXG-T-048=18+8 · §WXG-T-049=26+8 · §WXG-T-050=34+8 · §WXG-T-051=42+8 · §WXG-T-052=50+8 · §WXG-T-053=58+8 · §WXG-T-054=66+8 · §WXG-T-057=74+8 · §WXG-T-058=82+8 · §WXG-T-055=90+8 · §WXG-T-056=98+8 · §WXG-T-059=106+8 · §WXG-T-060=114+8 · §WXG-T-061=122+8 · §WXG-T-062=130+8 · §WXG-T-063=138+8 · §WXG-T-064=146+12 · §WXG-T-065=158+9
...
> 另有 97 个文件既未被 `ctx/ROUTES.md` 引用、也未命中热度/体积门槛，与路由读取无关，故不逐条列出（需要时查 `ctx/index.json`）。
