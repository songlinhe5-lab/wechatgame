...
## `production/TASKS.md` — 39 行 / 1412 tok / 实测读 4 次
...
## `production/TASKS-DETAIL.md` — 144 行 / 6726 tok

§WXG 任务台账 · 详情（标题制正文侧）=1+145 · §WXG-T-069=18+13 · §WXG-T-070=31+12 · §WXG-T-071=43+13 · §WXG-T-072=56+12 · §WXG-T-073=68+12 · §WXG-T-074=80+15 · §WXG-T-075=95+10 · §WXG-T-076=105+12 · §WXG-T-077=117+10 · §WXG-T-078=127+10 · §WXG-T-079=137+9
...
> 另有 117 个文件既未被 `ctx/ROUTES.md` 引用、也未命中热度/体积门槛，与路由读取无关，故不逐条列出（需要时查 `ctx/index.json`）。
