...
## `docs/architecture/architecture-beads.md` — 190 行 / 4328 tok / 实测读 35 次
...
## `games/beads/design/gdd/systems-index.md` — 242 行 / 7394 tok / 实测读 170 次

§系统清单与依赖索引（Systems Index）· beads=1+243 · §1 系统清单=9+16 · §2 依赖排序（Dependency Order）=25+30 · §3 全局数值基线（Global Constants）· ❄️ 冻结令=55+137 · §3.1 画布、坐标、安全区与布局带=67+16 · §3.2 色板与图案字符集=83+10 · §3.3 珠子网格（Bead Grid）=93+16 · §3.4 槽位托盘（Tray）=109+12 · §3.5 倒计时与失败=121+9 · §3.6 道具（Powerups）=130+10 · §3.7 星级与结算=140+9 · §3.8 可访问性（对齐 art-bible §3.3 与工作室 Standard 级）=149+10 · §3.9 包体预算=159+7 · §3.10 冲刺模式（Sprint）· 2026-09-12 用户拍板冻结（WXG-T-020）=166+16 · §3.11 失败续时（Revive）· 2026-09-14 用户拍板冻结（WXG-T-057 / T-B）=182+10 · §4 事件总线约定（供程序落码参考）=192+25 · §5 与框架层的接口假设=217+9 · §6 变更记录=226+18
...
## `production/TASKS.md` — 43 行 / 7849 tok / 实测读 4 次

§WXG 任务台账（SSOT）=1+44 · §待排（backlog，无号，立项时领取）=32+13
...
> 另有 92 个文件既未被 `ctx/ROUTES.md` 引用、也未命中热度/体积门槛，与路由读取无关，故不逐条列出（需要时查 `ctx/index.json`）。
