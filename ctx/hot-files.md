...
## `docs/agent/cocos-setup.md` — 364 行 / 7054 tok

§Cocos Creator + MCP 安装引导（docs/agent/cocos-setup.md）=1+365 · §1 前置事实与红线=10+20 · §2 七步总览（速查）=30+14 · §3 阶段 A — 安装 Cocos Creator 3.8.8=44+14 · §4 阶段 B — 创建工程=58+13 · §5 阶段 C — 安装 MCP 插件（全局扩展目录）=71+33 · §5.1 为什么装全局而非项目级=73+13 · §5.2 安装命令=86+10 · §5.3 启用=96+8 · §6 阶段 D — 启动 MCP 服务=104+14 · §7 阶段 E — 四 IDE 端点登记（已落盘，且已收口为单一正本）=118+65 · §8 阶段 F — 工具白名单（L1 机械防线）=183+18 · §9 阶段 G — 验证顺序与回填=201+11 · §10 升级流程=212+8 · §11 排错=220+12 · §12 本次已知未完成项（诚实记录）=232+16 · §13 beads 工程落地清单（WXG-T-053）=248+118 · §13.1 顺序约定（**先读这条，否则会撞目录**）=253+12 · §13.2 步骤 A — 编辑器 GUI（唯一必须人工的一步，约 5 分钟）=265+18 · §13.3 步骤 B — 仓库侧补齐（工程建好后**一次做完**）=283+34 · §13.4 步骤 C — 同步、检查、构建（命令）=317+21 · §13.5 beads 的预期与特有风险=338+10 · §13.6 检查表=348+18
